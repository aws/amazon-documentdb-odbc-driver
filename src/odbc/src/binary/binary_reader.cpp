...
int32_t BinaryReader::ReadInt8Array(const char* fieldName, int8_t* res,
                                    int32_t len) {
...
int32_t BinaryReader::ReadBoolArray(const char* fieldName, bool* res,
                                    int32_t len) {
...
int32_t BinaryReader::ReadInt16Array(const char* fieldName, int16_t* res,
                                     int32_t len) {
...
int32_t BinaryReader::ReadUInt16Array(const char* fieldName, uint16_t* res,
                                      int32_t len) {
...
int32_t BinaryReader::ReadInt32Array(const char* fieldName, int32_t* res,
                                     int32_t len) {
...
int32_t BinaryReader::ReadInt64Array(const char* fieldName, int64_t* res,
                                     int32_t len) {
...
int32_t BinaryReader::ReadFloatArray(const char* fieldName, float* res,
                                     int32_t len) {
...
int32_t BinaryReader::ReadDoubleArray(const char* fieldName, double* res,
                                      int32_t len) {
...
int32_t BinaryReader::ReadGuidArray(const char* fieldName, Guid* res,
                                    int32_t len) {
...
int32_t BinaryReader::ReadDateArray(const char* fieldName, Date* res,
                                    const int32_t len) {
...
int32_t BinaryReader::ReadTimestampArray(const char* fieldName, Timestamp* res,
                                         const int32_t len) {
...
int32_t BinaryReader::ReadTimeArray(const char* fieldName, Time* res,
                                    const int32_t len) {
  return impl->ReadTimeArray(fieldName, res, len);
}

int32_t BinaryReader::ReadString(const char* fieldName, char* res,
                                 int32_t len) {
