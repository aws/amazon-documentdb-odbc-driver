...
void BinaryWriter::WriteInt8Array(const char* fieldName, const int8_t* val,
                                  int32_t len) {
...
void BinaryWriter::WriteBoolArray(const char* fieldName, const bool* val,
                                  int32_t len) {
...
void BinaryWriter::WriteInt16Array(const char* fieldName, const int16_t* val,
                                   int32_t len) {
...
void BinaryWriter::WriteUInt16Array(const char* fieldName, const uint16_t* val,
                                    int32_t len) {
...
void BinaryWriter::WriteInt32Array(const char* fieldName, const int32_t* val,
                                   int32_t len) {
...
void BinaryWriter::WriteInt64Array(const char* fieldName, const int64_t* val,
                                   int32_t len) {
...
void BinaryWriter::WriteFloatArray(const char* fieldName, const float* val,
                                   int32_t len) {
...
void BinaryWriter::WriteDoubleArray(const char* fieldName, const double* val,
                                    int32_t len) {
...
void BinaryWriter::WriteGuidArray(const char* fieldName, const Guid* val,
                                  const int32_t len) {
...
void BinaryWriter::WriteDateArray(const char* fieldName, const Date* val,
                                  const int32_t len) {
...
void BinaryWriter::WriteTimestampArray(const char* fieldName,
                                       const Timestamp* val,
                                       const int32_t len) {
...
void BinaryWriter::WriteTimeArray(const char* fieldName, const Time* val,
                                  const int32_t len) {
