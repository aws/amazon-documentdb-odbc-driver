...
void HandshakeRequest::Write(impl::binary::BinaryWriterImpl& writer,
...
void QueryExecuteRequest::Write(impl::binary::BinaryWriterImpl& writer,
...
void QueryExecuteBatchRequest::Write(impl::binary::BinaryWriterImpl& writer,
                                     const ProtocolVersion& ver) const {
...
void QueryCloseRequest::Write(impl::binary::BinaryWriterImpl& writer,
                              const ProtocolVersion&) const {
...
void QueryFetchRequest::Write(impl::binary::BinaryWriterImpl& writer,
                              const ProtocolVersion&) const {
...
void QueryGetColumnsMetaRequest::Write(impl::binary::BinaryWriterImpl& writer,
                                       const ProtocolVersion&) const {
...
QueryGetResultsetMetaRequest::QueryGetResultsetMetaRequest(
    const std::string& schema, const std::string& sqlQuery)
    : schema(schema), sqlQuery(sqlQuery) {
  // No-op.
}
...
void QueryGetResultsetMetaRequest::Write(impl::binary::BinaryWriterImpl& writer,
                                         const ProtocolVersion&) const {
...
void QueryGetTablesMetaRequest::Write(impl::binary::BinaryWriterImpl& writer,
                                      const ProtocolVersion&) const {
...
void QueryGetParamsMetaRequest::Write(impl::binary::BinaryWriterImpl& writer,
                                      const ProtocolVersion&) const {
...
void QueryMoreResultsRequest::Write(impl::binary::BinaryWriterImpl& writer,
                                    const ProtocolVersion&) const {
...
StreamingBatchRequest::StreamingBatchRequest(
    const std::string& schema, const streaming::StreamingBatch& batch,
    bool last, int64_t order)
    : schema(schema), batch(batch), last(last), order(order) {
  // No-op.
}
...
void StreamingBatchRequest::Write(impl::binary::BinaryWriterImpl& writer,
                                  const ProtocolVersion&) const {
...
Response::Response() : status(ResponseStatus::UNKNOWN_ERROR), error() {
  // No-op.
}
...
HandshakeResponse::HandshakeResponse()
    : accepted(false), currentVer(), error() {
  // No-op.
}
...
void QueryExecuteBatchResponse::ReadOnSuccess(
...
StreamingBatchResponse::StreamingBatchResponse()
    : errorMessage(), errorCode(ResponseStatus::SUCCESS), order(0) {
  // No-op.
}
...
void StreamingBatchResponse::ReadOnSuccess(
    impl::binary::BinaryReaderImpl& reader, const ProtocolVersion&) {
  errorMessage = reader.ReadObject< std::string >();
  errorCode = reader.ReadInt32();
...
QueryFetchResponse::QueryFetchResponse(ResultPage& resultPage)
    : queryId(0), resultPage(resultPage) {
  // No-op.
}
...
void QueryGetParamsMetaResponse::ReadOnSuccess(
    impl::binary::BinaryReaderImpl& reader, const ProtocolVersion&) {
...
void QueryMoreResultsResponse::ReadOnSuccess(
    impl::binary::BinaryReaderImpl& reader, const ProtocolVersion&) {
  queryId = reader.ReadInt64();
