...
void BinaryUtils::ReadInt8Array(InteropInputStream* stream, int8_t* res,
                                const int32_t len) {
  stream->ReadInt8Array(res, len);
}

void BinaryUtils::WriteInt8Array(InteropOutputStream* stream, const int8_t* val,
                                 const int32_t len) {
...
void BinaryUtils::ReadBoolArray(InteropInputStream* stream, bool* res,
                                const int32_t len) {
  stream->ReadBoolArray(res, len);
}

void BinaryUtils::WriteBoolArray(InteropOutputStream* stream, const bool* val,
                                 const int32_t len) {
...
void BinaryUtils::ReadInt16Array(InteropInputStream* stream, int16_t* res,
                                 const int32_t len) {
  stream->ReadInt16Array(res, len);
}

void BinaryUtils::WriteInt16Array(InteropOutputStream* stream,
...
void BinaryUtils::ReadUInt16Array(InteropInputStream* stream, uint16_t* res,
                                  const int32_t len) {
  stream->ReadUInt16Array(res, len);
}

void BinaryUtils::WriteUInt16Array(InteropOutputStream* stream,
...
void BinaryUtils::ReadInt32Array(InteropInputStream* stream, int32_t* res,
                                 const int32_t len) {
  stream->ReadInt32Array(res, len);
}

void BinaryUtils::WriteInt32Array(InteropOutputStream* stream,
...
void BinaryUtils::ReadInt64Array(InteropInputStream* stream, int64_t* res,
                                 const int32_t len) {
  stream->ReadInt64Array(res, len);
}

void BinaryUtils::WriteInt64Array(InteropOutputStream* stream,
...
void BinaryUtils::ReadFloatArray(InteropInputStream* stream, float* res,
                                 const int32_t len) {
  stream->ReadFloatArray(res, len);
}

void BinaryUtils::WriteFloatArray(InteropOutputStream* stream, const float* val,
                                  const int32_t len) {
...
void BinaryUtils::ReadDoubleArray(InteropInputStream* stream, double* res,
                                  const int32_t len) {
  stream->ReadDoubleArray(res, len);
}

void BinaryUtils::WriteDoubleArray(InteropOutputStream* stream,
...
void BinaryUtils::WriteBinaryEnumEntry(InteropOutputStream* stream,
                                       int32_t typeId, int32_t ordinal) {
  stream->WriteInt32(typeId);
  stream->WriteInt32(ordinal);
}

void BinaryUtils::WriteString(InteropOutputStream* stream, const char* val,
                              const int32_t len) {
