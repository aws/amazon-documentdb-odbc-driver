...
namespace impl {
namespace binary {
BinaryReaderImpl::BinaryReaderImpl(
    InteropInputStream* stream, BinaryIdResolver* idRslvr, int32_t pos,
    bool usrType, int32_t typeId, int32_t hashCode, int32_t len, int32_t rawOff,
...
int32_t BinaryReaderImpl::ReadUInt16Array(const char* fieldName, uint16_t* res,
                                          const int32_t len) {
...
void BinaryReaderImpl::ReadGuidArrayInternal(InteropInputStream* stream,
...
void BinaryReaderImpl::ReadDateArrayInternal(InteropInputStream* stream,
...
void BinaryReaderImpl::ReadTimestampArrayInternal(InteropInputStream* stream,
                                                  Timestamp* res,
                                                  const int32_t len) {
  for (int i = 0; i < len; i++)
...
void BinaryReaderImpl::ReadTimeArrayInternal(InteropInputStream* stream,
...
int32_t BinaryReaderImpl::ReadString(const char* fieldName, char* res,
                                     const int32_t len) {
  CheckRawMode(false);
  CheckSingleMode(true);
...
int32_t BinaryReaderImpl::ReadCollection(const char* fieldName,
...
int32_t BinaryReaderImpl::ReadMap(const char* fieldName, MapType::Type* typ,
                                  int32_t* size) {
  CheckRawMode(false);
  CheckSingleMode(true);
...
CollectionType::Type BinaryReaderImpl::ReadCollectionTypeUnprotected() {
  ...
  CollectionType::Type typ =
      static_cast< CollectionType::Type >(stream->ReadInt8());
...
template <>
void BinaryReaderImpl::ReadTopObject0< ignite::binary::BinaryReader, int8_t >(
    int8_t& res) {
  res = ReadTopObject0< int8_t >(IGNITE_TYPE_BYTE, BinaryUtils::ReadInt8);
}

template <>
void BinaryReaderImpl::ReadTopObject0< ignite::binary::BinaryReader, bool >(
    bool& res) {
  res = ReadTopObject0< bool >(IGNITE_TYPE_BOOL, BinaryUtils::ReadBool);
}

template <>
void BinaryReaderImpl::ReadTopObject0< ignite::binary::BinaryReader, int16_t >(
    int16_t& res) {
  res = ReadTopObject0< int16_t >(IGNITE_TYPE_SHORT, BinaryUtils::ReadInt16);
}

template <>
void BinaryReaderImpl::ReadTopObject0< ignite::binary::BinaryReader, uint16_t >(
    uint16_t& res) {
  res = ReadTopObject0< uint16_t >(IGNITE_TYPE_CHAR, BinaryUtils::ReadUInt16);
}

template <>
void BinaryReaderImpl::ReadTopObject0< ignite::binary::BinaryReader, int32_t >(
    int32_t& res) {
  res = ReadTopObject0< int32_t >(IGNITE_TYPE_INT, BinaryUtils::ReadInt32);
}

template <>
void BinaryReaderImpl::ReadTopObject0< ignite::binary::BinaryReader, int64_t >(
    int64_t& res) {
  res = ReadTopObject0< int64_t >(IGNITE_TYPE_LONG, BinaryUtils::ReadInt64);
}

template <>
void BinaryReaderImpl::ReadTopObject0< ignite::binary::BinaryReader, float >(
    float& res) {
  res = ReadTopObject0< float >(IGNITE_TYPE_FLOAT, BinaryUtils::ReadFloat);
}

template <>
void BinaryReaderImpl::ReadTopObject0< ignite::binary::BinaryReader, double >(
    double& res) {
  res = ReadTopObject0< double >(IGNITE_TYPE_DOUBLE, BinaryUtils::ReadDouble);
}

template <>
void BinaryReaderImpl::ReadTopObject0< ignite::binary::BinaryReader, Guid >(
    Guid& res) {
  res = ReadTopObject0< Guid >(IGNITE_TYPE_UUID, BinaryUtils::ReadGuid);
}

template <>
void BinaryReaderImpl::ReadTopObject0< ignite::binary::BinaryReader, Date >(
    Date& res) {
...
template <>
void BinaryReaderImpl::ReadTopObject0< ignite::binary::BinaryReader,
...
template <>
void BinaryReaderImpl::ReadTopObject0< ignite::binary::BinaryReader, Time >(
    Time& res) {
  ...
  switch (schemaType) {
    ...
    case BinaryOffsetType::TWO_BYTES: {
      for (int32_t schemaPos = footerBegin; schemaPos < footerEnd;
        ...
        if (fieldId == currentFieldId)
          return static_cast< uint16_t >(stream->ReadInt16(schemaPos + 4))
                 + pos;
      }
      break;
    }
...
int32_t BinaryReaderImpl::StartContainerSession(bool expRawMode, int8_t expHdr,
                                                int32_t* size) {
