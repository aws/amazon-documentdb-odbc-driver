...
void IgniteError::SetError(const JniErrorCode jniCode, const char* jniCls,
                           const char* jniMsg, IgniteError& err) {
  if (jniCode == JniErrorCode::IGNITE_JNI_ERR_SUCCESS)
    ...
    if (jniCls) {
      ...
      else if (jniCls0.compare("org.apache.ignite.compute."
      ...
      else if (jniCls0.compare("org.apache.ignite.transactions."
