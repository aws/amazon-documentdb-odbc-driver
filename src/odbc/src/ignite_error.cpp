            ...
            else if (jniCode == IGNITE_JNI_ERR_GENERIC)
            {
                ...
                if (jniCls)
                {
                    ...
                    if (jniCls0.compare("java.lang.NoClassDefFoundError") == 0)
                    {
                        ...
                        stream << "Java class is not found (did you set DOCUMENTDB_HOME environment variable?)";
                    ...
                    else if (jniCls0.compare("java.lang.NoSuchMethodError") == 0)
                    {
                        ...
                        stream << "Java method is not found (did you set DOCUMENTDB_HOME environment variable?)";
