...
#include "ignite/odbc/documentdb/jni/utils.h"
#include "ignite/odbc/documentdbjni/java.h"

using namespace ignite::common;
using namespace ignite::odbc::documentdb::jni::java;
                                ...
                                while ((entry = readdir(dir)) != NULL) {
                                    ...
                                    if (entryPath.compare(".") != 0
                                        ...
                                        if (stat(entryFullPath.c_str(), &entryFullStat) != -1
                                            ...
                                            std::string childCp =
                                                ClasspathExploded(entryFullPath, false);
