...
#ifndef _DOCUMENTDB_ODBC_SQL_SQL_SET_STREAMING_COMMAND
#define _DOCUMENTDB_ODBC_SQL_SQL_SET_STREAMING_COMMAND
...
class SqlSetStreamingCommand : public SqlCommand {
 ...
 private:
   ...
   */
  static void ThrowUnexpectedTokenError(const SqlToken& token,
   ...
   * @return Integer number.
   */
  static int32_t ExpectPositiveInteger(SqlLexer& lexer,
...
#endif  //_DOCUMENTDB_ODBC_SQL_SQL_SET_STREAMING_COMMAND
