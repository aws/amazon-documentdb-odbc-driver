...
#ifndef _DOCUMENTDB_ODBC_SQL_SQL_TOKEN
#define _DOCUMENTDB_ODBC_SQL_SQL_TOKEN
...
class SqlToken {
 public:
   ...
   * Get token value.
   *
   * @return Pointer to the beginning of the value. Size of the value can be
   * obtained with @c GetSize().
   */
...
#endif  //_DOCUMENTDB_ODBC_SQL_SQL_TOKEN
