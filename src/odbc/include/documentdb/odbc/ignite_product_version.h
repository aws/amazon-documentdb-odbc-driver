...
/**
 * @file
 * Declares documentdb::odbc::IgniteProductVersion class.
 */

#ifndef _DOCUMENTDB_ODBC_IGNITE_PRODUCT_VERSION
#define _DOCUMENTDB_ODBC_IGNITE_PRODUCT_VERSION
...
#endif  //_DOCUMENTDB_ODBC_IGNITE_PRODUCT_VERSION
