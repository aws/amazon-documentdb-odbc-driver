...
#ifndef _DOCUMENTDB_ODBC_MESSAGE
#define _DOCUMENTDB_ODBC_MESSAGE
...
class QueryGetColumnsMetaRequest {
 public:
   ...
   */
  QueryGetColumnsMetaRequest(const std::string& schema,
...
class QueryGetResultsetMetaRequest {
 public:
   ...
   */
  QueryGetResultsetMetaRequest(const std::string& schema,
...
class QueryGetTablesMetaRequest {
 public:
   ...
   */
  QueryGetTablesMetaRequest(const std::string& catalog,
                            const std::string& schema, const std::string& table,
                            const std::string& tableTypes);
...
class QueryGetParamsMetaRequest {
 public:
   ...
   * @param sqlQuery SQL query itself.
   */
  QueryGetParamsMetaRequest(const std::string& schema,
                            const std::string& sqlQuery)
...
class StreamingBatchRequest {
 public:
   ...
   * @param order Order.
   */
  StreamingBatchRequest(const std::string& schema,
                        const streaming::StreamingBatch& batch, bool last,
                        int64_t order);
...
#endif  //_DOCUMENTDB_ODBC_MESSAGE
