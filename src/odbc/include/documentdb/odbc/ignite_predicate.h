...
/**
 * @file
 * Declares documentdb::odbc::IgnitePredicate class.
 */

#ifndef _DOCUMENTDB_ODBC_IGNITE_PREDICATE
#define _DOCUMENTDB_ODBC_IGNITE_PREDICATE
...
#endif  //_DOCUMENTDB_ODBC_IGNITE_PREDICATE
