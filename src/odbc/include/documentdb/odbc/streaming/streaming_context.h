...
#ifndef _DOCUMENTDB_ODBC_STREAMING_STREAMING_CONTEXT
#define _DOCUMENTDB_ODBC_STREAMING_STREAMING_CONTEXT
...
#endif  //_DOCUMENTDB_ODBC_STREAMING_STREAMING_CONTEXT
