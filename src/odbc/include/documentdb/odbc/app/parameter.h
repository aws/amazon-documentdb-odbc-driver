...
#ifndef _DOCUMENTDB_ODBC_APP_PARAMETER
#define _DOCUMENTDB_ODBC_APP_PARAMETER
...
class Parameter {
 public:
   ...
   */
  void Write(impl::binary::BinaryWriterImpl& writer, int offset = 0,
             SqlUlen idx = 0) const;
...
#endif  //_DOCUMENTDB_ODBC_APP_PARAMETER
