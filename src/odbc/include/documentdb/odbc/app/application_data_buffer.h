...
#ifndef _DOCUMENTDB_ODBC_APP_APPLICATION_DATA_BUFFER
#define _DOCUMENTDB_ODBC_APP_APPLICATION_DATA_BUFFER
...
#endif  //_DOCUMENTDB_ODBC_APP_APPLICATION_DATA_BUFFER
