...
#ifndef _DOCUMENTDB_ODBC_CONFIG_CONNECTION_STRING_PARSER
#define _DOCUMENTDB_ODBC_CONFIG_CONNECTION_STRING_PARSER
...
#endif  //_DOCUMENTDB_ODBC_CONFIG_CONNECTION_STRING_PARSER
