...
#ifndef _DOCUMENTDB_ODBC_CONFIG_CONFIGURATION
#define _DOCUMENTDB_ODBC_CONFIG_CONFIGURATION
...
#include "documentdb/odbc/config/settable_value.h"
...
#endif  //_DOCUMENTDB_ODBC_CONFIG_CONFIGURATION
