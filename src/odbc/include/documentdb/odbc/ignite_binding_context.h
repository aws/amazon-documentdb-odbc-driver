...
/**
 * @file
 * Declares documentdb::odbc::IgniteBindingContext class.
 */

#ifndef _DOCUMENTDB_ODBC_IGNITE_BINDING_CONTEXT
#define _DOCUMENTDB_ODBC_IGNITE_BINDING_CONTEXT

#include <documentdb/odbc/ignite_binding.h>
...
#endif  //_DOCUMENTDB_ODBC_IGNITE_BINDING_CONTEXT
