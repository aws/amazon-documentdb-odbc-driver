...
#ifndef _DOCUMENTDB_ODBC_PROTOCOL_VERSION
#define _DOCUMENTDB_ODBC_PROTOCOL_VERSION
...
class ProtocolVersion {
 public:
   ...
   */
  friend bool operator==(const ProtocolVersion& val1,
                         const ProtocolVersion& val2);
...
#endif  //_DOCUMENTDB_ODBC_PROTOCOL_VERSION
