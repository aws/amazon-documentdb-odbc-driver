...
/**
 * @file
 * Declares documentdb::odbc::ReferenceImplBase class and its implementations.
 */

#ifndef _DOCUMENTDB_ODBC_COMMON_REFERENCE_IMPL
#define _DOCUMENTDB_ODBC_COMMON_REFERENCE_IMPL
...
class ReferenceOwningRawPointer : public ReferenceImplBase {
 public:
   ...
   * Default constructor.
   */
  ReferenceOwningRawPointer() : ptr(0) {
    // No-op.
  }
   ...
   */
  ReferenceOwningRawPointer(T* ptr) : ptr(ptr) {
    // No-op.
  }
...
class ReferenceNonOwningRawPointer : public ReferenceImplBase {
 public:
   ...
   * Default constructor.
   */
  ReferenceNonOwningRawPointer() : ptr(0) {
    // No-op.
  }
   ...
   * @param ptr Pointer.
   */
  ReferenceNonOwningRawPointer(T* ptr) : ptr(ptr) {
    // No-op.
  }
...
class ConstReferenceNonOwningRawPointer : public ConstReferenceImplBase {
 public:
   ...
   * Default constructor.
   */
  ConstReferenceNonOwningRawPointer() : ptr(0) {
    // No-op.
  }
   ...
   * @param ptr Pointer.
   */
  ConstReferenceNonOwningRawPointer(const T* ptr) : ptr(ptr) {
    // No-op.
  }
...
#endif  //_DOCUMENTDB_ODBC_COMMON_REFERENCE_IMPL
