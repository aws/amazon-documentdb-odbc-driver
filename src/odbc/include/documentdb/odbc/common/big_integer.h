...
#ifndef _DOCUMENTDB_ODBC_COMMON_BIG_INTEGER
#define _DOCUMENTDB_ODBC_COMMON_BIG_INTEGER

#include <documentdb/odbc/common/dynamic_size_array.h>
#include <stdint.h>
...
#endif  //_DOCUMENTDB_ODBC_COMMON_BIG_INTEGER
