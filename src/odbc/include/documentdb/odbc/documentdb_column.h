...
#ifndef _DOCUMENTDB_ODBC_DOCUMENTDB_COLUMN
#define _DOCUMENTDB_ODBC_DOCUMENTDB_COLUMN
...
using documentdb::odbc::app::ConversionResult;
...
#endif  //_DOCUMENTDB_ODBC_DOCUMENTDB_COLUMN
