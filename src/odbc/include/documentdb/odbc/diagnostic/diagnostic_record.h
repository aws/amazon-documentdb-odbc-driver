...
#ifndef _DOCUMENTDB_ODBC_DIAGNOSTIC_DIAGNOSTIC_RECORD
#define _DOCUMENTDB_ODBC_DIAGNOSTIC_DIAGNOSTIC_RECORD
...
#endif  //_DOCUMENTDB_ODBC_DIAGNOSTIC_DIAGNOSTIC_RECORD
