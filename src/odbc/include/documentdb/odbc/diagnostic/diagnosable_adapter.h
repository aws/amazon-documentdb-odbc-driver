...
#ifndef _DOCUMENTDB_ODBC_DIAGNOSTIC_DIAGNOSABLE_ADAPTER
#define _DOCUMENTDB_ODBC_DIAGNOSTIC_DIAGNOSABLE_ADAPTER
...
#endif  //_DOCUMENTDB_ODBC_DIAGNOSTIC_DIAGNOSABLE_ADAPTER
