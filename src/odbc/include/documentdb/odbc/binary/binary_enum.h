...
/**
 * @file
 * Declares documentdb::odbc::binary::BinaryEnum class template and helping classes
 * to declare enum type specialization for user types.
 */

#ifndef _DOCUMENTDB_ODBC_BINARY_BINARY_ENUM
#define _DOCUMENTDB_ODBC_BINARY_BINARY_ENUM
...
#endif  //_DOCUMENTDB_ODBC_BINARY_BINARY_ENUM
