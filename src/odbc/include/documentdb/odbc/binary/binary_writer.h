...
/**
 * @file
 * Declares documentdb::odbc::binary::BinaryWriter class.
 */

#ifndef _DOCUMENTDB_ODBC_BINARY_BINARY_WRITER
#define _DOCUMENTDB_ODBC_BINARY_BINARY_WRITER
 ...
 *     function.
 */
class DOCUMENTDB_IMPORT_EXPORT BinaryWriter {
 public:
  /**
   * Constructor.
   *
  ...
  template < typename InputIterator >
  void WriteCollection(const char* fieldName, InputIterator first,
                       InputIterator last, CollectionType::Type typ) {
 ...
 private:
  ...
  documentdb::odbc::impl::binary::BinaryWriterImpl* impl;
};
}  // namespace binary
}  // namespace odbc
}  // namespace documentdb
#endif  //_DOCUMENTDB_ODBC_BINARY_BINARY_WRITER
