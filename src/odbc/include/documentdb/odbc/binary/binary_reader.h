...
/**
 * @file
 * Declares documentdb::odbc::binary::BinaryReader class.
 */

#ifndef _DOCUMENTDB_ODBC_BINARY_BINARY_READER
#define _DOCUMENTDB_ODBC_BINARY_BINARY_READER
...
class DOCUMENTDB_IMPORT_EXPORT BinaryReader {
 public:
   ...
   */
  BinaryReader(documentdb::odbc::impl::binary::BinaryReaderImpl* impl);
  ...
  std::string ReadString(const char* fieldName) {
    ...
    if (len != -1) {
      documentdb::odbc::common::FixedSizeArray< char > arr(len + 1);
...
#endif  //_DOCUMENTDB_ODBC_BINARY_BINARY_READER
