...
#ifndef _DOCUMENTDB_ODBC_BINARY_BINARY_CONTAINERS
#define _DOCUMENTDB_ODBC_BINARY_BINARY_CONTAINERS
...
class IGNITE_IMPORT_EXPORT BinaryStringArrayWriter {
 public:
   ...
   *
   * @throw DocumentDbError if the writer instance is closed already.
   */
...
class IGNITE_IMPORT_EXPORT BinaryStringArrayReader {
 public:
   ...
   *
   * @throw DocumentDbError if there is no element to read.
   */
...
#endif  //_DOCUMENTDB_ODBC_BINARY_BINARY_CONTAINERS
