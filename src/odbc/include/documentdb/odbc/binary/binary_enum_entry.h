...
/**
 * @file
 * Declares documentdb::odbc::binary::BinaryEnumEntry class.
 */

#ifndef _DOCUMENTDB_ODBC_BINARY_BINARY_ENUM_ENTRY
#define _DOCUMENTDB_ODBC_BINARY_BINARY_ENUM_ENTRY
...
#endif  //_DOCUMENTDB_ODBC_BINARY_BINARY_ENUM_ENTRY
