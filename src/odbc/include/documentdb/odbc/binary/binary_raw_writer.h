...
/**
 * @file
 * Declares documentdb::odbc::binary::BinaryRawWriter class.
 */

#ifndef _DOCUMENTDB_ODBC_BINARY_BINARY_RAW_WRITER
#define _DOCUMENTDB_ODBC_BINARY_BINARY_RAW_WRITER
...
class DOCUMENTDB_IMPORT_EXPORT BinaryRawWriter {
 public:
   ...
   */
  BinaryRawWriter(documentdb::odbc::impl::binary::BinaryWriterImpl* impl);
...
#endif  //_DOCUMENTDB_ODBC_BINARY_BINARY_RAW_WRITER
