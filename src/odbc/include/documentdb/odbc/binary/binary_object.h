...
#ifndef _DOCUMENTDB_ODBC_BINARY_BINARY_OBJECT
#define _DOCUMENTDB_ODBC_BINARY_BINARY_OBJECT
...
class DOCUMENTDB_IMPORT_EXPORT BinaryObject {
 ...
 public:
   ...
   */
  BinaryObject(const impl::binary::BinaryObjectImpl& impl) : impl(impl) {
    // No-op.
  }
   ...
   */
  BinaryObject(const BinaryObject& other) : impl(other.impl) {
    // No-op.
  }
  ...
  /**
   * Deserialize object.
   * @throw DocumentDbError if the object can not be deserialized to
   *     specified type.
   *
...
#endif  //_DOCUMENTDB_ODBC_BINARY_BINARY_OBJECT
