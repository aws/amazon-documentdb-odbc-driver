...
/**
 * @file
 * Declares documentdb::odbc::cluster::IgniteCluster class.
 */

#ifndef _DOCUMENTDB_ODBC_CLUSTER_DOCUMENTDB_ODBC_CLUSTER
#define _DOCUMENTDB_ODBC_CLUSTER_DOCUMENTDB_ODBC_CLUSTER
...
class DOCUMENTDB_IMPORT_EXPORT IgniteCluster {
 public:
  ...
  IgniteCluster(common::concurrent::SharedPointer<
                documentdb::odbc::impl::cluster::IgniteClusterImpl >
                    impl);
...
#endif  //_DOCUMENTDB_ODBC_CLUSTER_DOCUMENTDB_ODBC_CLUSTER
