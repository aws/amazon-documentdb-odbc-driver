...
/**
 * @file
 * Declares documentdb::odbc::cluster::ClusterNode class.
 */

#ifndef _DOCUMENTDB_ODBC_CLUSTER_CLUSTER_NODE
#define _DOCUMENTDB_ODBC_CLUSTER_CLUSTER_NODE
...
class IGNITE_IMPORT_EXPORT ClusterNode {
 public:
   ...
   */
  ClusterNode(common::concurrent::SharedPointer<
              documentdb::odbc::impl::cluster::ClusterNodeImpl >
                  impl);
   ...
   *
   * @throw DocumentDbError in case of attribute name does not exist
  ...
  /**
   * Get globally unique node ID. A new ID is generated every time a node
   * restarts
   *
   * @return Node Guid.
   */
...
#endif  //_DOCUMENTDB_ODBC_CLUSTER_CLUSTER_NODE
