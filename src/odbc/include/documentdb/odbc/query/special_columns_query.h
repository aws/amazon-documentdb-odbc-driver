...
#ifndef _DOCUMENTDB_ODBC_QUERY_SPECIAL_COLUMNS_QUERY
#define _DOCUMENTDB_ODBC_QUERY_SPECIAL_COLUMNS_QUERY
...
#endif  //_DOCUMENTDB_ODBC_QUERY_SPECIAL_COLUMNS_QUERY
