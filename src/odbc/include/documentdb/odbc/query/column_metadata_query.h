...
#ifndef _DOCUMENTDB_ODBC_QUERY_COLUMN_METADATA_QUERY
#define _DOCUMENTDB_ODBC_QUERY_COLUMN_METADATA_QUERY
...
#endif  //_DOCUMENTDB_ODBC_QUERY_COLUMN_METADATA_QUERY
