...
/**
 * @file
 * Declares documentdb::odbc::cache::query::QueryArgument class template and
 * documentdb::odbc::cache::query::QueryArgumentBase interface.
 */

#ifndef _DOCUMENTDB_ODBC_IMPL_CACHE_QUERY_QUERY_ARGUMENT
#define _DOCUMENTDB_ODBC_IMPL_CACHE_QUERY_QUERY_ARGUMENT
...
class QueryArgumentBase {
 public:
   ...
   */
  virtual void Write(documentdb::odbc::binary::BinaryRawWriter& writer) = 0;
};
...
class QueryArgument : public QueryArgumentBase {
 public:
   ...
   */
  QueryArgument(const QueryArgument& other) : val(other.val) {
    // No-op.
  }
  ...
  virtual void Write(documentdb::odbc::binary::BinaryRawWriter& writer) {
...
class QueryInt8ArrayArgument : public QueryArgumentBase {
 public:
   ...
   */
  QueryInt8ArrayArgument(const int8_t* src, int32_t len) : val(src, src + len) {
    // No-op.
  }
   ...
   * @param other Other instance.
   */
  QueryInt8ArrayArgument(const QueryInt8ArrayArgument& other) : val(other.val) {
    // No-op.
  }
...
#endif  //_DOCUMENTDB_ODBC_IMPL_CACHE_QUERY_QUERY_ARGUMENT
