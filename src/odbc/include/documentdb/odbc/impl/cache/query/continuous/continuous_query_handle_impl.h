 ...
 * @file
 * Declares
 * documentdb::odbc::impl::cache::query::continuous::ContinuousQueryHandleImpl
 * class.
 */

#ifndef _DOCUMENTDB_ODBC_IMPL_CACHE_QUERY_CONTINUOUS_CONTINUOUS_QUERY_HANDLE_IMPL
#define _DOCUMENTDB_ODBC_IMPL_CACHE_QUERY_CONTINUOUS_CONTINUOUS_QUERY_HANDLE_IMPL
...
class DOCUMENTDB_IMPORT_EXPORT ContinuousQueryHandleImpl {
 ...
 public:
   ...
   */
  QueryCursorImpl* GetInitialQueryCursor(DocumentDbError& err);
...
#endif  //_DOCUMENTDB_ODBC_IMPL_CACHE_QUERY_CONTINUOUS_CONTINUOUS_QUERY_HANDLE_IMPL
