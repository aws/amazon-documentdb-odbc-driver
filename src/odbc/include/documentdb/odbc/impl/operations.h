...
#ifndef _DOCUMENTDB_ODBC_IMPL_OPERATIONS
#define _DOCUMENTDB_ODBC_IMPL_OPERATIONS
...
#include "documentdb/odbc/impl/helpers.h"
...
class InputOperation {
 public:
  ...
  virtual void ProcessInput(
      documentdb::odbc::impl::binary::BinaryWriterImpl& writer) = 0;
};
...
class In1Operation : public InputOperation {
 public:
  ...
  virtual void ProcessInput(
      documentdb::odbc::impl::binary::BinaryWriterImpl& writer) {
 ...
 public:
  ...
  virtual void ProcessOutput(binary::BinaryReaderImpl& reader) {
    ...
    for (int i = 0; i < cnt; i++) {
      ...
      res.push_back(documentdb::odbc::cache::CacheEntry< K, V >(key, val));
    }
  }
 ...
 */
template < typename K, typename V, typename Iter,
           typename Pair = documentdb::odbc::cache::CacheEntry< K, V > >
...
#endif  //_DOCUMENTDB_ODBC_IMPL_OPERATIONS
