...
/**
 * @file
 * Declares documentdb::odbc::impl::binary::BinaryObjectHeader class.
 */

#ifndef _DOCUMENTDB_ODBC_IMPL_BINARY_BINARY_OBJECT_HEADER
#define _DOCUMENTDB_ODBC_IMPL_BINARY_BINARY_OBJECT_HEADER
...
class IGNITE_IMPORT_EXPORT BinaryObjectHeader {
 public:
   ...
   */
  static BinaryObjectHeader FromMemory(interop::InteropMemory& mem,
                                       int32_t offset);
   ...
   */
  BinaryObjectHeader(const BinaryObjectHeader& other) : header(other.header) {
    // No-op.
  }
  ...
  int32_t GetFooterOffset() const {
    ...
    // There is schema. Regardless of raw data presence, footer starts with
    // schema.
...
#endif  //_DOCUMENTDB_ODBC_IMPL_BINARY_BINARY_OBJECT_HEADER
