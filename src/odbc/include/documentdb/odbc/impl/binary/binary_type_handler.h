...
#ifndef _DOCUMENTDB_ODBC_IMPL_BINARY_BINARY_TYPE_HANDLER
#define _DOCUMENTDB_ODBC_IMPL_BINARY_BINARY_TYPE_HANDLER
...
class BinaryTypeHandler {
 public:
   ...
   */
  void OnFieldWritten(int32_t fieldId, std::string fieldName,
                      int32_t fieldTypeId);
...
#endif  //_DOCUMENTDB_ODBC_IMPL_BINARY_BINARY_TYPE_HANDLER
