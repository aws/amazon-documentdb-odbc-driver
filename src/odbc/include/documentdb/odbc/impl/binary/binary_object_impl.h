...
/**
 * @file
 * Declares documentdb::odbc::binary::BinaryObject class.
 */

#ifndef _DOCUMENTDB_ODBC_IMPL_BINARY_BINARY_OBJECT_IMPL
#define _DOCUMENTDB_ODBC_IMPL_BINARY_BINARY_OBJECT_IMPL
...
class IGNITE_IMPORT_EXPORT BinaryObjectImpl {
 public:
   ...
   * @throw DocumentDbError if the memory at the specified offset
   ...
   */
  static BinaryObjectImpl FromMemory(interop::InteropMemory& mem,
                                     int32_t offset,
                                     BinaryTypeManager* metaMgr);

  /**
   * Deserialize object.
   * @throw DocumentDbError if the object can not be deserialized to specified type.
   *
  ...
  /**
   * Get field.
   * @throw DocumentDbError if the there is no specified field or if it
  ...
  /**
   * Get object length.
   * @throw DocumentDbError if the object is not in a valid state.
   *
 ...
 private:
   ...
   *
   * @throw DocumentDbError if idRslvr is not set.
   */
...
#endif  //_DOCUMENTDB_ODBC_IMPL_BINARY_BINARY_OBJECT_IMPL
