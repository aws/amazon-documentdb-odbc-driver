...
#ifndef _DOCUMENTDB_ODBC_IMPL_BINARY_BINARY_TYPE_SNAPSHOT
#define _DOCUMENTDB_ODBC_IMPL_BINARY_BINARY_TYPE_SNAPSHOT
...
typedef documentdb::odbc::common::concurrent::SharedPointer< Snap > SPSnap;
}  // namespace binary
}  // namespace impl
}  // namespace odbc
}  // namespace documentdb

#endif  //_DOCUMENTDB_ODBC_IMPL_BINARY_BINARY_TYPE_SNAPSHOT
