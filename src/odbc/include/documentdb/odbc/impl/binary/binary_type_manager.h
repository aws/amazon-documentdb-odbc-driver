...
#ifndef _DOCUMENTDB_ODBC_IMPL_BINARY_BINARY_TYPE_MANAGER
#define _DOCUMENTDB_ODBC_IMPL_BINARY_BINARY_TYPE_MANAGER
...
class DOCUMENTDB_IMPORT_EXPORT BinaryTypeManager {
 public:
   ...
   */
  common::concurrent::SharedPointer< BinaryTypeHandler > GetHandler(
   ...
   */
  bool ProcessPendingUpdates(DocumentDbError& err);
...
#endif  //_DOCUMENTDB_ODBC_IMPL_BINARY_BINARY_TYPE_MANAGER
