...
#ifndef _DOCUMENTDB_ODBC_IMPL_BINARY_BINARY_WRITER
#define _DOCUMENTDB_ODBC_IMPL_BINARY_BINARY_WRITER
...
class DOCUMENTDB_IMPORT_EXPORT BinaryWriterImpl {
 public:
   ...
   */
  void WriteBinaryEnum(documentdb::odbc::binary::BinaryEnumEntry entry);
  ...
  void WriteBinaryEnum(const char* fieldName,
                       documentdb::odbc::binary::BinaryEnumEntry entry);
   ...
   * @return Session ID.
   */
  int32_t WriteCollection(documentdb::odbc::binary::CollectionType::Type typ);
   ...
   * @return Session ID.
   */
  int32_t WriteMap(documentdb::odbc::binary::MapType::Type typ);
  ...
  void WriteEnum(T val) {
    ...
    documentdb::odbc::binary::BinaryEnumEntry entry(TypeMeta::GetTypeId(),
...
#endif  //_DOCUMENTDB_ODBC_IMPL_BINARY_BINARY_WRITER
