...
/**
 * @file
 * Declares documentdb::odbc::impl::compute::SingleJobComputeTaskHolder class
 * template.
 */

#ifndef _DOCUMENTDB_ODBC_IMPL_COMPUTE_SINGLE_JOB_COMPUTE_TASK
#define _DOCUMENTDB_ODBC_IMPL_COMPUTE_SINGLE_JOB_COMPUTE_TASK
...
class SingleJobComputeTaskHolder : public ComputeTaskHolder {
 public:
   ...
   */
  SingleJobComputeTaskHolder(int64_t handle) : ComputeTaskHolder(handle) {
    // No-op.
  }
...
#endif  //_DOCUMENTDB_ODBC_IMPL_COMPUTE_SINGLE_JOB_COMPUTE_TASK
