...
/**
 * @file
 * Declares documentdb::odbc::impl::compute::ComputeTaskHolder.
 */

#ifndef _DOCUMENTDB_ODBC_IMPL_COMPUTE_COMPUTE_TASK_HOLDER
#define _DOCUMENTDB_ODBC_IMPL_COMPUTE_COMPUTE_TASK_HOLDER

#include <stdint.h>

#include <documentdb/odbc/documentdb_error.h>
#include <documentdb/odbc/impl/compute/compute_job_holder.h>
...
class ComputeTaskHolder {
 public:
   ...
   */
  ComputeTaskHolder(int64_t handle) : handle(handle) {
    // No-op.
  }
   ...
   * @param err Error.
   */
  virtual void JobResultError(const DocumentDbError& err) = 0;
...
template <>
inline int8_t PrimitiveFutureResult< int8_t >(int64_t value) {
  return static_cast< int8_t >(value);
}

template <>
inline int16_t PrimitiveFutureResult< int16_t >(int64_t value) {
  return static_cast< int16_t >(value);
}

template <>
inline int32_t PrimitiveFutureResult< int32_t >(int64_t value) {
  return static_cast< int32_t >(value);
}

template <>
inline int64_t PrimitiveFutureResult< int64_t >(int64_t value) {
  return static_cast< int64_t >(value);
}

template <>
inline bool PrimitiveFutureResult< bool >(int64_t value) {
  return value != 0;
}

template <>
inline uint16_t PrimitiveFutureResult< uint16_t >(int64_t value) {
  return static_cast< uint16_t >(value);
}

template <>
inline float PrimitiveFutureResult< float >(int64_t value) {
...
template <>
inline double PrimitiveFutureResult< double >(int64_t value) {
...
#endif  //_DOCUMENTDB_ODBC_IMPL_COMPUTE_COMPUTE_TASK_HOLDER
