...
/**
 * @file
 * Declares documentdb::odbc::impl::compute::JavaComputeTaskHolder class template.
 */

#ifndef _DOCUMENTDB_ODBC_IMPL_COMPUTE_JAVA_COMPUTE_TASK_HOLDER
#define _DOCUMENTDB_ODBC_IMPL_COMPUTE_JAVA_COMPUTE_TASK_HOLDER
...
#endif  //_DOCUMENTDB_ODBC_IMPL_COMPUTE_JAVA_COMPUTE_TASK_HOLDER
