...
/**
 * @file
 * Declares documentdb::odbc::impl::compute::ComputeJobHolder class template.
 */

#ifndef _DOCUMENTDB_ODBC_IMPL_COMPUTE_COMPUTE_JOB_HOLDER
#define _DOCUMENTDB_ODBC_IMPL_COMPUTE_COMPUTE_JOB_HOLDER
...
#endif  //_DOCUMENTDB_ODBC_IMPL_COMPUTE_COMPUTE_JOB_HOLDER
