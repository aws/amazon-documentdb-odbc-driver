...
#ifndef _DOCUMENTDB_ODBC_IMPL_INTEROP_INTEROP_OUTPUT_STREAM
#define _DOCUMENTDB_ODBC_IMPL_INTEROP_INTEROP_OUTPUT_STREAM
...
#endif  //_DOCUMENTDB_ODBC_IMPL_INTEROP_INTEROP_OUTPUT_STREAM
