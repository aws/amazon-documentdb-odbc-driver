...
#ifndef _DOCUMENTDB_ODBC_IMPL_INTEROP_INTEROP_MEMORY
#define _DOCUMENTDB_ODBC_IMPL_INTEROP_INTEROP_MEMORY
...
#endif  //_DOCUMENTDB_ODBC_IMPL_INTEROP_INTEROP_MEMORY
