...
#ifndef _DOCUMENTDB_ODBC_IMPL_CLUSTER_CLUSTER_NODE_IMPL
#define _DOCUMENTDB_ODBC_IMPL_CLUSTER_CLUSTER_NODE_IMPL

#include <documentdb/odbc/common/utils.h>
#include <documentdb/odbc/common/concurrent.h>

#include <documentdb/odbc/guid.h>
#include <documentdb/odbc/ignite_product_version.h>
 ...
 public:
  ...
  T GetAttribute(std::string name) const {
    ...
    interop::InteropInputStream stream(
        const_cast< interop::InteropMemory* >(mem.Get()));
...
#endif  //_DOCUMENTDB_ODBC_IMPL_CLUSTER_CLUSTER_NODE_IMPL
