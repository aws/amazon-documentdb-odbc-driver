...
#ifndef _DOCUMENTDB_ODBC_IMPL_CLUSTER_DOCUMENTDB_ODBC_CLUSTER_IMPL
#define _DOCUMENTDB_ODBC_IMPL_CLUSTER_DOCUMENTDB_ODBC_CLUSTER_IMPL
...
class IGNITE_FRIEND_EXPORT IgniteClusterImpl {
 public:
   ...
   */
  documentdb::odbc::cluster::ClusterGroup ForLocal();
...
#endif  //_DOCUMENTDB_ODBC_IMPL_CLUSTER_DOCUMENTDB_ODBC_CLUSTER_IMPL
