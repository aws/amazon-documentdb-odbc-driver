...
#ifndef _DOCUMENTDB_ODBC_IMPL_HANDLE_REGISTRY
#define _DOCUMENTDB_ODBC_IMPL_HANDLE_REGISTRY
...
class IGNITE_IMPORT_EXPORT HandleRegistry {
 public:
   ...
   * @return Handle.
   */
  int64_t AllocateCritical(
      const common::concurrent::SharedPointer< void >& target);
 ...
 private:
   ...
   */
  int64_t Allocate0(const common::concurrent::SharedPointer< void >& target,
...
#endif  //_DOCUMENTDB_ODBC_IMPL_HANDLE_REGISTRY
