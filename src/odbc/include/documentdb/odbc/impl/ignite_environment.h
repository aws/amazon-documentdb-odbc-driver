...
#ifndef _DOCUMENTDB_ODBC_IMPL_IGNITE_ENVIRONMENT
#define _DOCUMENTDB_ODBC_IMPL_IGNITE_ENVIRONMENT
...
class DOCUMENTDB_IMPORT_EXPORT IgniteEnvironment {
 ...
 public:
   ...
   */
  void OnContinuousQueryListenerApply(
   ...
   */
  int64_t OnContinuousQueryFilterCreate(
      common::concurrent::SharedPointer< interop::InteropMemory >& mem);
   ...
   * @param mem Memory with data.
   */
  int64_t OnContinuousQueryFilterApply(
      common::concurrent::SharedPointer< interop::InteropMemory >& mem);
   ...
   * @retrun Memory.
   */
  common::concurrent::SharedPointer< interop::InteropMemory > GetMemory(
      int64_t memPtr);
   ...
   */
  documentdb::odbc::Ignite* GetIgnite();
...
#endif  //_DOCUMENTDB_ODBC_IMPL_IGNITE_ENVIRONMENT
