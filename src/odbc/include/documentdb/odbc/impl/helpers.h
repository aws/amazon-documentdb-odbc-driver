...
#ifndef _DOCUMENTDB_ODBC_IMPL_HELPERS
#define _DOCUMENTDB_ODBC_IMPL_HELPERS
...
struct ContainerEntryWriteHelper {
  ...
  static void Write(binary::BinaryWriterImpl& writer,
                    const documentdb::odbc::cache::CacheEntry< K, V >& val) {
...
#endif  //_DOCUMENTDB_ODBC_IMPL_HELPERS
