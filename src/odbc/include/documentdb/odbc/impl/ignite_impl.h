...
#ifndef _DOCUMENTDB_ODBC_IMPL_DOCUMENTDB_ODBC_IMPL
#define _DOCUMENTDB_ODBC_IMPL_DOCUMENTDB_ODBC_IMPL

#include <documentdb/odbc/jni/java.h>
#include <documentdb/odbc/common/utils.h>
#include <documentdb/odbc/common/concurrent.h>
#include <documentdb/odbc/common/lazy.h>
...
class DOCUMENTDB_FRIEND_EXPORT IgniteImpl : private interop::InteropTarget {
  ...
  typedef common::concurrent::SharedPointer< compute::ComputeImpl >
      SP_ComputeImpl;
  typedef common::concurrent::SharedPointer< IgniteBindingImpl >
      SP_IgniteBindingImpl;
  typedef common::concurrent::SharedPointer< cache::CacheAffinityImpl >
 ...
 public:
  ...
  /**
   * Get affinity service to provide information about data partitioning and
   * distribution.
   *
   ...
   */
  SP_CacheAffinityImpl GetAffinity(const std::string& cacheName,
                                   DocumentDbError& err);
   ...
   * @param err Error.
   */
  cache::CacheImpl* GetCache(const char* name, DocumentDbError& err);
   ...
   * @param err Error.
   */
  cache::CacheImpl* GetOrCreateCache(const char* name, DocumentDbError& err);
   ...
   * @param err Error.
   */
  cache::CacheImpl* CreateCache(const char* name, DocumentDbError& err);
   ...
   * @return ComputeImpl instance.
   */
  SP_ComputeImpl GetCompute(documentdb::odbc::cluster::ClusterGroup grp);
...
#endif  //_DOCUMENTDB_ODBC_IMPL_DOCUMENTDB_ODBC_IMPL
