...
/**
 * @file
 * Declares documentdb::odbc::cache::query::continuous::ContinuousQuery class.
 */

#ifndef _DOCUMENTDB_ODBC_CACHE_QUERY_CONTINUOUS_CONTINUOUS_QUERY
#define _DOCUMENTDB_ODBC_CACHE_QUERY_CONTINUOUS_CONTINUOUS_QUERY
...
#include <documentdb/odbc/cache/event/cache_entry_event_filter.h>
...
class ContinuousQuery {
 ...
 public:
  ...
  ContinuousQuery(Reference< event::CacheEntryEventListener< K, V > > lsnr)
      : impl(new impl::cache::query::continuous::ContinuousQueryImpl< K, V >(
          lsnr, false)) {
    // No-op.
  }
 ...
 private:
  ...
  common::concurrent::SharedPointer<
      impl::cache::query::continuous::ContinuousQueryImpl< K, V > >
      impl;
};
}  // namespace continuous
}  // namespace query
...
#endif  //_DOCUMENTDB_ODBC_CACHE_QUERY_CONTINUOUS_CONTINUOUS_QUERY
