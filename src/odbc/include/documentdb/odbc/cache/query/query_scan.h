...
/**
 * @file
 * Declares documentdb::odbc::cache::query::ScanQuery class.
 */

#ifndef _DOCUMENTDB_ODBC_CACHE_QUERY_QUERY_SCAN
#define _DOCUMENTDB_ODBC_CACHE_QUERY_QUERY_SCAN
...
#endif  //_DOCUMENTDB_ODBC_CACHE_QUERY_QUERY_SCAN
