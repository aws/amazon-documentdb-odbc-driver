...
/**
 * @file
 * Declares documentdb::odbc::cache::query::SqlQuery class.
 */

#ifndef _DOCUMENTDB_ODBC_CACHE_QUERY_QUERY_SQL
#define _DOCUMENTDB_ODBC_CACHE_QUERY_QUERY_SQL
...
#endif  //_DOCUMENTDB_ODBC_CACHE_QUERY_QUERY_SQL
