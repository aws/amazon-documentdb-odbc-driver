...
/**
 * @file
 * Declares documentdb::odbc::cache::query::QueryFieldsRow class.
 */

#ifndef _DOCUMENTDB_ODBC_CACHE_QUERY_QUERY_FIELDS_ROW
#define _DOCUMENTDB_ODBC_CACHE_QUERY_QUERY_FIELDS_ROW
...
#endif  //_DOCUMENTDB_ODBC_CACHE_QUERY_QUERY_FIELDS_ROW
