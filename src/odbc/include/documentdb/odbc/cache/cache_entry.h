...
/**
 * @file
 * Declares documentdb::odbc::cache::CacheEntry class.
 */

#ifndef _DOCUMENTDB_ODBC_CACHE_CACHE_ENTRY
#define _DOCUMENTDB_ODBC_CACHE_CACHE_ENTRY
...
#endif  //_DOCUMENTDB_ODBC_CACHE_CACHE_ENTRY
