...
/**
 * @file
 * Declares documentdb::odbc::cache::event::CacheEntryEventListener class.
 */

#ifndef _DOCUMENTDB_ODBC_CACHE_EVENT_CACHE_ENTRY_EVENT_LISTENER
#define _DOCUMENTDB_ODBC_CACHE_EVENT_CACHE_ENTRY_EVENT_LISTENER
...
#endif  //_DOCUMENTDB_ODBC_CACHE_EVENT_CACHE_ENTRY_EVENT_LISTENER
