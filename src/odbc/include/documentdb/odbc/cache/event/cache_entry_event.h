...
/**
 * @file
 * Declares documentdb::odbc::cache::event::CacheEntryEvent class.
 */

#ifndef _DOCUMENTDB_ODBC_CACHE_EVENT_CACHE_ENTRY_EVENT
#define _DOCUMENTDB_ODBC_CACHE_EVENT_CACHE_ENTRY_EVENT
...
#endif  //_DOCUMENTDB_ODBC_CACHE_EVENT_CACHE_ENTRY_EVENT
