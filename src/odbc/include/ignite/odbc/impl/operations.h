    ...
    namespace odbc
    {
        namespace impl
        {
            ...
            public:
                 ...
                 * @param writer Writer.
                 */
                virtual void ProcessInput(ignite::odbc::impl::binary::BinaryWriterImpl& writer) = 0;
            };
            ...
            public:
                ...
                virtual void ProcessInput(ignite::odbc::impl::binary::BinaryWriterImpl& writer)
                {
            ...
            public:
                 ...
                 * Constructor.
                 */
                OutQueryGetAllOperation(std::vector<ignite::odbc::cache::CacheEntry<K, V> >& res) : res(res)
                {
                    // No-op.
                }
             ...
             * Output query GET ALL operation.
             */
            template<typename K, typename V, typename Iter, typename Pair = ignite::odbc::cache::CacheEntry<K,V> >
