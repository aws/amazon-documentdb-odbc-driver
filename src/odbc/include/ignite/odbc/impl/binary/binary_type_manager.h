...
#ifndef _IGNITE_ODBC_IMPL_BINARY_BINARY_TYPE_MANAGER
#define _IGNITE_ODBC_IMPL_BINARY_BINARY_TYPE_MANAGER
...
#endif  //_IGNITE_ODBC_IMPL_BINARY_BINARY_TYPE_MANAGER
