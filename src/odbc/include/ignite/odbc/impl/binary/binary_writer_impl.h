...
class IGNITE_IMPORT_EXPORT BinaryWriterImpl {
 public:
   ...
   */
  BinaryWriterImpl(interop::InteropOutputStream* stream,
                   BinaryIdResolver* idRslvr, BinaryTypeManager* metaMgr,
                   BinaryTypeHandler* metaHnd, int32_t start);

  /**
   * Constructor used to construct light-weight writer allowing only raw
   * operations and primitive objects.
   *
   * @param stream Interop stream.
   * @param metaMgr Type manager.
   */
   ...
   * @param len Array length.
   */
  void WriteBoolArray(const char* fieldName, const bool* val,
                      const int32_t len);
   ...
   * @param len Array length.
   */
  void WriteInt16Array(const char* fieldName, const int16_t* val,
                       const int32_t len);
   ...
   * @param len Array length.
   */
  void WriteUInt16Array(const char* fieldName, const uint16_t* val,
                        const int32_t len);
   ...
   * @param len Array length.
   */
  void WriteInt32Array(const char* fieldName, const int32_t* val,
                       const int32_t len);
   ...
   * @param len Array length.
   */
  void WriteInt64Array(const char* fieldName, const int64_t* val,
                       const int32_t len);
   ...
   * @param len Array length.
   */
  void WriteFloatArray(const char* fieldName, const float* val,
                       const int32_t len);
   ...
   * @param len Array length.
   */
  void WriteDoubleArray(const char* fieldName, const double* val,
                        const int32_t len);
   ...
   * @param len Array length.
   */
  void WriteGuidArray(const char* fieldName, const Guid* val,
                      const int32_t len);
   ...
   * @param len Array length.
   */
  void WriteDateArray(const char* fieldName, const Date* val,
                      const int32_t len);
   ...
   * @param len Array length.
   */
  void WriteTimestampArray(const char* fieldName, const Timestamp* val,
                           const int32_t len);
   ...
   * @param len Array length.
   */
  void WriteTimeArray(const char* fieldName, const Time* val,
                      const int32_t len);
   ...
   * @return Session ID.
   */
  int32_t WriteCollection(const char* fieldName,
   ...
   */
  template < typename InputIterator >
  void WriteCollection(const char* fieldName, InputIterator first,
                       InputIterator last,
                       ignite::binary::CollectionType::Type typ) {
  ...
  void WriteEnum(T val) {
    ...
    ignite::binary::BinaryEnumEntry entry(TypeMeta::GetTypeId(),
  ...
  void WriteTopObject0(const T& obj) {
    ...
    if (BType::IsNull(obj))
      ...
      BinaryWriterImpl writerImpl(stream, &idRslvr, metaMgr, metaHnd.Get(),
                                  pos);
      W writer(&writerImpl);
      ...
      // Reserve space for the Object Length, Schema ID and Schema or Raw
      // Offset.
      stream->Reserve(12);
      ...
      // We are using direct constructor here to avoid check-overhead, as we
      // know at this point that underlying memory contains valid binary object.
      BinaryObjectImpl binObj(*stream->GetMemory(), pos, &idRslvr, metaMgr);

      int32_t hash =
          BinaryUtils::GetDataHashCode(binObj.GetData(), binObj.GetLength());
 ...
 private:
   ...
   */
  template < typename T >
  void WritePrimitiveRaw(const T val,
   ...
   */
  template < typename T >
  void WritePrimitiveArrayRaw(const T* val, const int32_t len,
                              void (*func)(interop::InteropOutputStream*,
                                           const T*, const int32_t),
                              const int8_t hdr);
   ...
   */
  template < typename T >
  void WritePrimitive(const char* fieldName, const T val,
                      void (*func)(interop::InteropOutputStream*, T),
                      const int8_t typ, const int32_t len);
   ...
   */
  template < typename T >
  void WritePrimitiveArray(const char* fieldName, const T* val,
                           const int32_t len,
                           void (*func)(interop::InteropOutputStream*, const T*,
                                        const int32_t),
                           const int8_t hdr, const int32_t lenShift);
  ...
  template < typename T >
  void WriteTopObject0(const T obj,
                       void (*func)(impl::interop::InteropOutputStream*, T),
                       const int8_t hdr) {
...
BinaryWriterImpl::WriteTopObject0< ignite::binary::BinaryWriter, int8_t >(
    const int8_t& obj);

template <>
void IGNITE_IMPORT_EXPORT
BinaryWriterImpl::WriteTopObject0< ignite::binary::BinaryWriter, bool >(
    const bool& obj);

template <>
void IGNITE_IMPORT_EXPORT
BinaryWriterImpl::WriteTopObject0< ignite::binary::BinaryWriter, int16_t >(
    const int16_t& obj);

template <>
void IGNITE_IMPORT_EXPORT
BinaryWriterImpl::WriteTopObject0< ignite::binary::BinaryWriter, uint16_t >(
    const uint16_t& obj);

template <>
void IGNITE_IMPORT_EXPORT
BinaryWriterImpl::WriteTopObject0< ignite::binary::BinaryWriter, int32_t >(
    const int32_t& obj);

template <>
void IGNITE_IMPORT_EXPORT
BinaryWriterImpl::WriteTopObject0< ignite::binary::BinaryWriter, int64_t >(
    const int64_t& obj);

template <>
void IGNITE_IMPORT_EXPORT
BinaryWriterImpl::WriteTopObject0< ignite::binary::BinaryWriter, float >(
    const float& obj);

template <>
void IGNITE_IMPORT_EXPORT
BinaryWriterImpl::WriteTopObject0< ignite::binary::BinaryWriter, double >(
    const double& obj);

template <>
void IGNITE_IMPORT_EXPORT
BinaryWriterImpl::WriteTopObject0< ignite::binary::BinaryWriter, Guid >(
    const Guid& obj);

template <>
void IGNITE_IMPORT_EXPORT
BinaryWriterImpl::WriteTopObject0< ignite::binary::BinaryWriter, Date >(
    const Date& obj);

template <>
void IGNITE_IMPORT_EXPORT
BinaryWriterImpl::WriteTopObject0< ignite::binary::BinaryWriter, Timestamp >(
    const Timestamp& obj);

template <>
void IGNITE_IMPORT_EXPORT
BinaryWriterImpl::WriteTopObject0< ignite::binary::BinaryWriter, Time >(
    const Time& obj);

template <>
void IGNITE_IMPORT_EXPORT
BinaryWriterImpl::WriteTopObject0< ignite::binary::BinaryWriter, std::string >(
...
#endif  //_IGNITE_ODBC_IMPL_BINARY_BINARY_WRITER
