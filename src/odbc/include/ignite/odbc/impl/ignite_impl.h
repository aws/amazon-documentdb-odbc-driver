...
#ifndef _IGNITE_ODBC_IMPL_IGNITE_ODBC_IMPL
#define _IGNITE_ODBC_IMPL_IGNITE_ODBC_IMPL

#include <ignite/odbc/jni/java.h>
#include <ignite/odbc/common/utils.h>
#include <ignite/odbc/common/concurrent.h>
#include <ignite/odbc/common/lazy.h>
...
class IGNITE_FRIEND_EXPORT IgniteImpl : private interop::InteropTarget {
 ...
 public:
   ...
   * @return ComputeImpl instance.
   */
  SP_ComputeImpl GetCompute(ignite::odbc::cluster::ClusterGroup grp);
...
#endif  //_IGNITE_ODBC_IMPL_IGNITE_ODBC_IMPL
