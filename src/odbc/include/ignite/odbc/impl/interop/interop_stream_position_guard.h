...
#ifndef _IGNITE_ODBC_IMPL_INTEROP_INTEROP_STREAM_POSITION_GUARD
#define _IGNITE_ODBC_IMPL_INTEROP_INTEROP_STREAM_POSITION_GUARD
...
#endif  //_IGNITE_ODBC_IMPL_INTEROP_INTEROP_STREAM_POSITION_GUARD
