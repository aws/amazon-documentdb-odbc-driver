...
#ifndef _IGNITE_ODBC_IMPL_INTEROP_INTEROP_INPUT_STREAM
#define _IGNITE_ODBC_IMPL_INTEROP_INTEROP_INPUT_STREAM
...
#endif  //_IGNITE_ODBC_IMPL_INTEROP_INTEROP_INPUT_STREAM
