...
#ifndef _IGNITE_ODBC_IMPL_INTEROP_INTEROP_OUTPUT_STREAM
#define _IGNITE_ODBC_IMPL_INTEROP_INTEROP_OUTPUT_STREAM
...
#endif  //_IGNITE_ODBC_IMPL_INTEROP_INTEROP_OUTPUT_STREAM
