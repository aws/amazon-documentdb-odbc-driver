...
#ifndef _IGNITE_ODBC_IMPL_INTEROP_INTEROP_TARGET
#define _IGNITE_ODBC_IMPL_INTEROP_INTEROP_TARGET
        ...
        namespace impl 
        {
            namespace interop
            {
                ...
                public:
                     ...
                     */
                    InteropTarget(ignite::odbc::common::concurrent::SharedPointer<IgniteEnvironment> env, jobject javaRef);
                    ...
                    */
                     ...
                     */
                    ignite::odbc::common::concurrent::SharedPointer<IgniteEnvironment> GetEnvironmentPointer()
                    {
                        return env;
                    }
...
#endif //_IGNITE_ODBC_IMPL_INTEROP_INTEROP_TARGET
