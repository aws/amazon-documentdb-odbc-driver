...
#ifndef _IGNITE_ODBC_IMPL_CACHE_CACHE_ENTRY_PROCESSOR_HOLDER
#define _IGNITE_ODBC_IMPL_CACHE_CACHE_ENTRY_PROCESSOR_HOLDER

#include <ignite/odbc/common/common.h>
#include <ignite/odbc/cache/mutable_cache_entry.h>
...
class CacheEntryProcessorHolder {
 public:
  ...
  R Process(const K& key, V& value, bool exists,
    ...
    typedef ignite::odbc::cache::MutableCacheEntry< K, V > Entry;
...
#endif  //_IGNITE_ODBC_IMPL_CACHE_CACHE_ENTRY_PROCESSOR_HOLDER
