...
#ifndef _IGNITE_ODBC_CACHE_IMPL
#define _IGNITE_ODBC_CACHE_IMPL

#include <ignite/odbc/cache/query/query_scan.h>
#include <ignite/odbc/cache/query/query_sql.h>
#include <ignite/odbc/cache/query/query_text.h>
#include <ignite/odbc/cache/query/query_sql_fields.h>
        ...
        namespace impl 
        {
            namespace cache
            {
                ...
                public:
                     ...
                     */
                    CacheImpl(char* name, ignite::odbc::common::concurrent::SharedPointer<IgniteEnvironment> env, jobject javaRef);
                    ...
                    */
                     ...
                     * @return Query cursor.
                     */
                    query::QueryCursorImpl* QuerySql(const ignite::odbc::cache::query::SqlQuery& qry, IgniteError& err);
                     ...
                     * @return Query cursor.
                     */
                    query::QueryCursorImpl* QueryText(const ignite::odbc::cache::query::TextQuery& qry, IgniteError& err);
                     ...
                     * @return Query cursor.
                     */
                    query::QueryCursorImpl* QueryScan(const ignite::odbc::cache::query::ScanQuery& qry, IgniteError& err);
                     ...
                     * @return Query cursor.
                     */
                    query::QueryCursorImpl* QuerySqlFields(const ignite::odbc::cache::query::SqlFieldsQuery& qry, IgniteError& err);
                    ...
                    query::continuous::ContinuousQueryHandleImpl* QueryContinuous(
                        const common::concurrent::SharedPointer<query::continuous::ContinuousQueryImplBase> qry,
                        const ignite::odbc::cache::query::SqlQuery& initialQry, IgniteError& err);
                    ...
                    query::continuous::ContinuousQueryHandleImpl* QueryContinuous(
                        const common::concurrent::SharedPointer<query::continuous::ContinuousQueryImplBase> qry,
                        const ignite::odbc::cache::query::TextQuery& initialQry, IgniteError& err);
                    ...
                    query::continuous::ContinuousQueryHandleImpl* QueryContinuous(
                        const common::concurrent::SharedPointer<query::continuous::ContinuousQueryImplBase> qry,
                        const ignite::odbc::cache::query::ScanQuery& initialQry, IgniteError& err);
