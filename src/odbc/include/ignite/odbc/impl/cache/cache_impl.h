...
class IGNITE_IMPORT_EXPORT CacheImpl : private interop::InteropTarget {
 public:
  ...
  query::QueryCursorImpl* QuerySql(
      const ignite::odbc::cache::query::SqlQuery& qry, IgniteError& err);
  ...
  query::QueryCursorImpl* QueryText(
      const ignite::odbc::cache::query::TextQuery& qry, IgniteError& err);
  ...
  query::QueryCursorImpl* QueryScan(
      const ignite::odbc::cache::query::ScanQuery& qry, IgniteError& err);
  ...
  query::QueryCursorImpl* QuerySqlFields(
      const ignite::odbc::cache::query::SqlFieldsQuery& qry, IgniteError& err);
  ...
  query::continuous::ContinuousQueryHandleImpl* QueryContinuous(
      const common::concurrent::SharedPointer<
          query::continuous::ContinuousQueryImplBase >
          qry,
      const ignite::odbc::cache::query::TextQuery& initialQry,
      IgniteError& err);
  ...
  query::continuous::ContinuousQueryHandleImpl* QueryContinuous(
      const common::concurrent::SharedPointer<
          query::continuous::ContinuousQueryImplBase >
          qry,
      const ignite::odbc::cache::query::ScanQuery& initialQry,
      IgniteError& err);
