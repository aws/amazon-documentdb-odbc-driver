...
/**
 * @file
 * Declares ignite::odbc::cache::query::QueryArgument class template and
 * ignite::odbc::cache::query::QueryArgumentBase interface.
 */

#ifndef _IGNITE_ODBC_IMPL_CACHE_QUERY_QUERY_ARGUMENT
#define _IGNITE_ODBC_IMPL_CACHE_QUERY_QUERY_ARGUMENT
...
class QueryArgumentBase {
 public:
   ...
   */
  virtual void Write(ignite::odbc::binary::BinaryRawWriter& writer) = 0;
};
...
class QueryArgument : public QueryArgumentBase {
 public:
  ...
  virtual void Write(ignite::odbc::binary::BinaryRawWriter& writer) {
...
#endif  //_IGNITE_ODBC_IMPL_CACHE_QUERY_QUERY_ARGUMENT
