...
/**
 * @file
 * Declares ignite::odbc::impl::cache::query::continuous::ContinuousQueryImpl class.
 */
                ...
                namespace query
                {
                    namespace continuous
                    {
                        ...
                        public:
                             ...
                             */
                            virtual void ReadAndProcessEvents(ignite::odbc::binary::BinaryRawReader& reader) = 0;
                        ...
                        public:
                             ...
                             * @param loc Whether query should be executed locally.
                             */
                            ContinuousQueryImpl(Reference<ignite::odbc::cache::event::CacheEntryEventListener<K, V> >& lsnr,
                                bool loc) :
                             ...
                             *     started.
                             */
                            void SetListener(Reference<ignite::odbc::cache::event::CacheEntryEventListener<K, V> >& val)
                            {
                                lsnr = val;
                            }
                             ...
                             */
                            const ignite::odbc::cache::event::CacheEntryEventListener<K, V>& GetListener() const
                            {
                                return lsnr.Get();
                            }
                             ...
                             * @param reader Reader to use.
                             */
                            virtual void ReadAndProcessEvents(ignite::odbc::binary::BinaryRawReader& reader)
                            {
                                // Number of events.
