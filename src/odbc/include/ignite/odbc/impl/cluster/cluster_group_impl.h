        ...
        namespace impl
        {
            namespace cluster
            {
                ...
                class IGNITE_FRIEND_EXPORT ClusterGroupImpl : private interop::InteropTarget
                {
                    ...
                    typedef common::concurrent::SharedPointer<std::vector<ignite::odbc::cluster::ClusterNode> > SP_ClusterNodes;
                ...
                public:
                     ...
                     */
                    SP_ClusterGroupImpl ForNodes(std::vector<ignite::odbc::cluster::ClusterNode> nodes);
                     ...
                     */
                    SP_ClusterGroupImpl ForPredicate(IgnitePredicate<ignite::odbc::cluster::ClusterNode>* pred);
                     ...
                     * @return Pointer to predicate.
                     */
                    const IgnitePredicate<ignite::odbc::cluster::ClusterNode>* GetPredicate() const;
                     ...
                     */
                    std::vector<ignite::odbc::cluster::ClusterNode> GetTopology(int64_t version);
