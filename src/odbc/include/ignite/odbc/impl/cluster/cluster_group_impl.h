...
#ifndef _IGNITE_ODBC_IMPL_CLUSTER_CLUSTER_GROUP_IMPL
#define _IGNITE_ODBC_IMPL_CLUSTER_CLUSTER_GROUP_IMPL

#include <ignite/odbc/common/concurrent.h>
#include <ignite/odbc/jni/java.h>

#include <ignite/odbc/ignite_predicate.h>
...
class IGNITE_FRIEND_EXPORT ClusterGroupImpl : private interop::InteropTarget {
 ...
 public:
   ...
   * node.
   */
  SP_ClusterGroupImpl ForHost(ignite::odbc::cluster::ClusterNode node);
   ...
   */
  SP_ClusterGroupImpl ForNode(ignite::odbc::cluster::ClusterNode node);
  ...
  SP_ClusterGroupImpl ForNodes(
      std::vector< ignite::odbc::cluster::ClusterNode > nodes);
  ...
  SP_ClusterGroupImpl ForPredicate(
      IgnitePredicate< ignite::odbc::cluster::ClusterNode >* pred);
   ...
   * @return Local node.
   */
  ignite::odbc::cluster::ClusterNode GetLocalNode();
   ...
   * @throw IgniteError if there are no nodes in the cluster group.
   */
  ignite::odbc::cluster::ClusterNode GetNode();
   ...
   */
  ignite::odbc::cluster::ClusterNode GetNode(Guid nid);
   ...
   */
  std::vector< ignite::odbc::cluster::ClusterNode > GetNodes();
   ...
   */
  IgnitePredicate< ignite::odbc::cluster::ClusterNode >* GetPredicate();
   ...
   * @return Pointer to predicate.
   */
  const IgnitePredicate< ignite::odbc::cluster::ClusterNode >* GetPredicate()
      const;
   ...
   */
  std::vector< ignite::odbc::cluster::ClusterNode > GetTopology(
      int64_t version);
 ...
 private:
   ...
   */
  std::vector< ignite::odbc::cluster::ClusterNode > RefreshNodes();
...
#endif  //_IGNITE_ODBC_IMPL_CLUSTER_CLUSTER_GROUP_IMPL
