...
/**
 * @file
 * Declares ignite::odbc::impl::compute::SingleJobComputeTaskHolder class
 * template.
 */

#ifndef _IGNITE_ODBC_IMPL_COMPUTE_SINGLE_JOB_COMPUTE_TASK
#define _IGNITE_ODBC_IMPL_COMPUTE_SINGLE_JOB_COMPUTE_TASK
...
#endif  //_IGNITE_ODBC_IMPL_COMPUTE_SINGLE_JOB_COMPUTE_TASK
