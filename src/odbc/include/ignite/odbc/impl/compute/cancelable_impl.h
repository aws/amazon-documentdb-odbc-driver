...
/**
 * @file
 * Declares ignite::odbc::impl::compute::CancelableImpl class.
 */

#ifndef _IGNITE_ODBC_IMPL_COMPUTE_CANCELABLE_IMPL
#define _IGNITE_ODBC_IMPL_COMPUTE_CANCELABLE_IMPL
