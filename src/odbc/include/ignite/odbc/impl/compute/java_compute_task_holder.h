...
/**
 * @file
 * Declares ignite::odbc::impl::compute::JavaComputeTaskHolder class template.
 */

#ifndef _IGNITE_ODBC_IMPL_COMPUTE_JAVA_COMPUTE_TASK_HOLDER
#define _IGNITE_ODBC_IMPL_COMPUTE_JAVA_COMPUTE_TASK_HOLDER
