...
/**
 * @file
 * Declares ignite::odbc::impl::compute::ComputeImpl class.
 */

#ifndef _IGNITE_ODBC_IMPL_COMPUTE_COMPUTE_IMPL
#define _IGNITE_ODBC_IMPL_COMPUTE_COMPUTE_IMPL

#include <ignite/odbc/common/common.h>
#include <ignite/odbc/common/promise.h>
...
#include <ignite/odbc/impl/compute/java_compute_task_holder.h>
#include <ignite/odbc/impl/compute/single_job_compute_task_holder.h>
#include <ignite/odbc/impl/compute/multiple_job_compute_task_holder.h>
 ...
 private:
  ...
  void WriteJavaTask(const std::string& taskName, const A* arg,
    ...
    if (!ProjectionContainsPredicate())
      ...
      typedef std::vector< ignite::odbc::cluster::ClusterNode > ClusterNodes;
...
#endif  //_IGNITE_ODBC_IMPL_COMPUTE_COMPUTE_IMPL
