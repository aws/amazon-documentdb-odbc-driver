...
/**
 * @file
 * Declares ignite::odbc::impl::compute::ComputeJobResult class template.
 */

#ifndef _IGNITE_ODBC_IMPL_COMPUTE_COMPUTE_JOB_RESULT
#define _IGNITE_ODBC_IMPL_COMPUTE_COMPUTE_JOB_RESULT
...
#endif //_IGNITE_ODBC_IMPL_COMPUTE_COMPUTE_JOB_RESULT
