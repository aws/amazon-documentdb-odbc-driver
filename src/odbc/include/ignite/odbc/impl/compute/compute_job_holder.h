...
/**
 * @file
 * Declares ignite::odbc::impl::compute::ComputeJobHolder class template.
 */

#ifndef _IGNITE_ODBC_IMPL_COMPUTE_COMPUTE_JOB_HOLDER
#define _IGNITE_ODBC_IMPL_COMPUTE_COMPUTE_JOB_HOLDER
