...
/**
 * @file
 * Declares ignite::odbc::cache::query::SqlQuery class.
 */

#ifndef _IGNITE_ODBC_CACHE_QUERY_QUERY_SQL
#define _IGNITE_ODBC_CACHE_QUERY_QUERY_SQL
...
#endif  //_IGNITE_ODBC_CACHE_QUERY_QUERY_SQL
