...
/**
 * @file
 * Declares ignite::odbc::cache::query::QueryCursor class template.
 */

#ifndef _IGNITE_ODBC_CACHE_QUERY_QUERY_CURSOR
#define _IGNITE_ODBC_CACHE_QUERY_QUERY_CURSOR
...
#endif //_IGNITE_ODBC_CACHE_QUERY_QUERY_CURSOR
