...
/**
 * @file
 * Declares ignite::odbc::cache::query::continuous::ContinuousQueryHandle class.
 */

#ifndef _IGNITE_ODBC_CACHE_QUERY_CONTINUOUS_CONTINUOUS_QUERY_HANDLE
#define _IGNITE_ODBC_CACHE_QUERY_CONTINUOUS_CONTINUOUS_QUERY_HANDLE
