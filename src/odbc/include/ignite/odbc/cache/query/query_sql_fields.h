...
/**
 * @file
 * Declares ignite::odbc::cache::query::SqlFieldsQuery class.
 */

#ifndef _IGNITE_ODBC_CACHE_QUERY_QUERY_SQL_FIELDS
#define _IGNITE_ODBC_CACHE_QUERY_QUERY_SQL_FIELDS

#include <stdint.h>
#include <string>
#include <vector>

#include <ignite/odbc/impl/cache/query/query_argument.h>
...
#endif  //_IGNITE_ODBC_CACHE_QUERY_QUERY_SQL_FIELDS
