...
/**
 * @file
 * Declares ignite::odbc::cache::query::QueryFieldsCursor class.
 */

#ifndef _IGNITE_ODBC_CACHE_QUERY_QUERY_FIELDS_CURSOR
#define _IGNITE_ODBC_CACHE_QUERY_QUERY_FIELDS_CURSOR
...
#include "ignite/odbc/cache/query/query_fields_row.h"
        ...
        namespace cache
        {
            namespace query
            {
                ...
                private:
                    ...
                    ignite::odbc::common::concurrent::SharedPointer<impl::cache::query::QueryCursorImpl> impl;
                };
            }
        }    
    }    
...
#endif //_IGNITE_ODBC_CACHE_QUERY_QUERY_FIELDS_CURSOR
