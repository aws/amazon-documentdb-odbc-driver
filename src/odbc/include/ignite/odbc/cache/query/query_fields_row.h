...
/**
 * @file
 * Declares ignite/odbc::cache::query::QueryFieldsRow class.
 */

#ifndef _IGNITE_ODBC_CACHE_QUERY_QUERY_FIELDS_ROW
#define _IGNITE_ODBC_CACHE_QUERY_QUERY_FIELDS_ROW
        ...
        namespace cache
        {
            namespace query
            {
                ...
                private:
                    ...
                    ignite::odbc::common::concurrent::SharedPointer<impl::cache::query::QueryFieldsRowImpl> impl;
                };
            }
        }    
    }    
...
#endif //_IGNITE_ODBC_CACHE_QUERY_QUERY_FIELDS_ROW
