...
/**
 * @file
 * Declares ignite::odbc::cache::event::CacheEntryEventListener class.
 */

#ifndef _IGNITE_ODBC_CACHE_EVENT_CACHE_ENTRY_EVENT_LISTENER
#define _IGNITE_ODBC_CACHE_EVENT_CACHE_ENTRY_EVENT_LISTENER
