...
/**
 * @file
 * Declares ignite::odbc::cache::event::CacheEntryEventFilter class.
 */

#ifndef _IGNITE_ODBC_CACHE_EVENT_CACHE_ENTRY_EVENT_FILTER
#define _IGNITE_ODBC_CACHE_EVENT_CACHE_ENTRY_EVENT_FILTER
