...
/**
 * @file
 * Declares ignite::odbc::cache::event::CacheEntryEvent class.
 */

#ifndef _IGNITE_ODBC_CACHE_EVENT_CACHE_ENTRY_EVENT
#define _IGNITE_ODBC_CACHE_EVENT_CACHE_ENTRY_EVENT
