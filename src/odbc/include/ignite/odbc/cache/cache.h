...
/**
 * @file
 * Declares ignite::odbc::cache::Cache class.
 */

#ifndef _IGNITE_ODBC_CACHE_CACHE
#define _IGNITE_ODBC_CACHE_CACHE
...
#include <ignite/odbc/cache/cache_peek_mode.h>
#include <ignite/odbc/cache/query/query_cursor.h>
#include <ignite/odbc/cache/query/query_fields_cursor.h>
    ...
    namespace odbc
    {
        namespace cache
        {
            ...
            public:
                ...
                int32_t Size()
                {
                    return Size(ignite::odbc::cache::CachePeekMode::ALL);
                }
                ...
                {
                    return Size(ignite::odbc::cache::CachePeekMode::ALL, err);
                }
                 ...
                 * @code{.cpp}
                 * IGNITE_EXPORTED_CALL void IgniteModuleInit(ignite::odbc::IgniteBindingContext& context)
                 * {
                 ...
                 * ignite::odbc::cacheEntryProcessor class.
                 *
...
#endif //_IGNITE_ODBC_CACHE_CACHE
