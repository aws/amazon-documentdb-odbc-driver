...
/**
 * @file
 * Declares ignite::odbc::cache::MutableCacheEntry class template.
 */

#ifndef _IGNITE_ODBC_CACHE_MUTABLE_CACHE_ENTRY
#define _IGNITE_ODBC_CACHE_MUTABLE_CACHE_ENTRY
...
#endif  //_IGNITE_ODBC_CACHE_MUTABLE_CACHE_ENTRY
