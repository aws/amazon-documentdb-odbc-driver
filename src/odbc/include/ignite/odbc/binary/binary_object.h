...
#ifndef _IGNITE_ODBC_BINARY_BINARY_OBJECT
#define _IGNITE_ODBC_BINARY_BINARY_OBJECT
...
class IGNITE_IMPORT_EXPORT BinaryObject {
  friend class ignite::odbc::impl::binary::BinaryWriterImpl;
...
#endif //_IGNITE_ODBC_BINARY_BINARY_OBJECT