...
/**
 * @file
 * Declares ignite::odbc::binary::BinaryRawWriter class.
 */

#ifndef _IGNITE_ODBC_BINARY_BINARY_RAW_WRITER
#define _IGNITE_ODBC_BINARY_BINARY_RAW_WRITER
...
class IGNITE_IMPORT_EXPORT BinaryRawWriter {
 public:
   ...
   */
  BinaryRawWriter(ignite::odbc::impl::binary::BinaryWriterImpl* impl);
