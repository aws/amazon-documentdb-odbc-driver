...
/**
 * @file
 * Declares ignite::odbc::binary::BinaryReader class.
 */

#ifndef _IGNITE_ODBC_BINARY_BINARY_READER
#define _IGNITE_ODBC_BINARY_BINARY_READER
...
class IGNITE_IMPORT_EXPORT BinaryReader {
 public:
   ...
   */
  BinaryReader(ignite::odbc::impl::binary::BinaryReaderImpl* impl);
 ...
 private:
  ...
  ignite::odbc::impl::binary::BinaryReaderImpl* impl;
};
}  // namespace binary
}  // namespace odbc
}  // namespace ignite
