...
/**
 * @file
 * Declares ignite::odbc::binary::BinaryRawReader class.
 */

#ifndef _IGNITE_ODBC_BINARY_BINARY_RAW_READER
#define _IGNITE_ODBC_BINARY_BINARY_RAW_READER
...
class IGNITE_IMPORT_EXPORT BinaryRawReader {
 public:
   ...
   */
  BinaryRawReader(ignite::odbc::impl::binary::BinaryReaderImpl* impl);
...
#endif  //_IGNITE_ODBC_BINARY_BINARY_RAW_READER
