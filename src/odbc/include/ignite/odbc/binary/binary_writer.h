...
/**
 * @file
 * Declares ignite::odbc::binary::BinaryWriter class.
 */

#ifndef _IGNITE_ODBC_BINARY_BINARY_WRITER
#define _IGNITE_ODBC_BINARY_BINARY_WRITER
...
class IGNITE_IMPORT_EXPORT BinaryWriter {
 ...
 private:
  ...
  ignite::odbc::impl::binary::BinaryWriterImpl* impl;
};
}  // namespace binary
}  // namespace odbc
}  // namespace ignite
