 ...
 */
 ...
 /**
  * @file
  * Declares ignite::odbc::cluster::ClusterNode class.
  */

#ifndef _IGNITE_ODBC_CLUSTER_CLUSTER_NODE
#define _IGNITE_ODBC_CLUSTER_CLUSTER_NODE
    ...
    namespace odbc
    {
        namespace cluster
        {
            ...
            public:
                 ...
                 */
                ClusterNode(common::concurrent::SharedPointer<ignite::odbc::impl::cluster::ClusterNodeImpl> impl);
            ...
            private:
                common::concurrent::SharedPointer<ignite::odbc::impl::cluster::ClusterNodeImpl> impl;
            };
        }
    }
}

#endif //_IGNITE_ODBC_CLUSTER_CLUSTER_NODE
