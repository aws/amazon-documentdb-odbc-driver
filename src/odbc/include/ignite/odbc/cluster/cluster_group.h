...
/**
 * @file
 * Declares ignite::odbc::cluster::ClusterGroup class.
 */

#ifndef _IGNITE_ODBC_CLUSTER_CLUSTER_GROUP
#define _IGNITE_ODBC_CLUSTER_CLUSTER_GROUP
...
#endif  //_IGNITE_ODBC_CLUSTER_CLUSTER_GROUP
