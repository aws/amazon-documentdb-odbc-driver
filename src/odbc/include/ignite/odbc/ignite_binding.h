...
/**
 * @file
 * Declares ignite::odbc::IgniteBinding class.
 */

#ifndef _IGNITE_ODBC_IGNITE_BINDING
#define _IGNITE_ODBC_IGNITE_BINDING

#include <ignite/odbc/common/common.h>
#include <ignite/odbc/common/concurrent.h>

#include <ignite/odbc/impl/ignite_binding_impl.h>
#include <ignite/odbc/impl/bindings.h>
...
namespace ignite
{
    namespace odbc
    {
        ...
        public:
             ...
             *
             * Registred type should be a child of ignite::odbc::cache::CacheEntryProcessor
             * class.
             */
            template<typename P>
             ...
             *
             * Registred type should be a child of ignite::odbc::cache::event::CacheEntryEventFilter
             * class.
             */
            template<typename F>
             ...
             *
             * Registred type should be a child of ignite::odbc::compute::ComputeFunc
             * class.
             */
            template<typename F>
...
#endif //_IGNITE_ODBC_IGNITE_BINDING
