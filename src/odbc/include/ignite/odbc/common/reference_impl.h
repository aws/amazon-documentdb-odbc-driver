...
/**
 * @file
 * Declares ignite::odbc::ReferenceImplBase class and its implementations.
 */

#ifndef _IGNITE_ODBC_COMMON_REFERENCE_IMPL
#define _IGNITE_ODBC_COMMON_REFERENCE_IMPL
...
#endif  //_IGNITE_ODBC_COMMON_REFERENCE_IMPL
