...
/**
 * @file
 * Declares ignite::odbc::Future class template.
 */
...
class Future {
 ...
 public:
   ...
   */
  Future(const Future< ValueType >& src) : state(src.state) {
    // No-op.
  }
 ...
 private:
   ...
   */
  Future(common::concurrent::SharedPointer< common::SharedState< ValueType > >
             state0)
      : state(state0) {
    // No-op.
  }
