...
/**
 * @file
 * Declares ignite::odbc::Ignite class.
 */

#ifndef _IGNITE_ODBC_IGNITE
#define _IGNITE_ODBC_IGNITE

#include <ignite/odbc/impl/ignite_impl.h>

#include <ignite/odbc/ignite_configuration.h>
#include <ignite/odbc/cache/cache.h>
#include <ignite/odbc/cache/cache_affinity.h>
#include <ignite/odbc/compute/compute.h>
#include <ignite/odbc/cluster/ignite_cluster.h>
...
class IGNITE_IMPORT_EXPORT Ignite {
 ...
 private:
  ...
  ignite::odbc::common::concurrent::SharedPointer< impl::IgniteImpl > impl;
};
}  // namespace odbc
}  // namespace ignite

#endif  //_IGNITE_ODBC_IGNITE
