        ...
        namespace system
        {
            namespace ui
            {
                    ...
                    int sizeX, int sizeY, const char* title, int id, bool state)
                {
                    ...
                    child->Create(WS_CHILD | WS_VISIBLE | BS_CHECKBOX | WS_TABSTOP, posX, posY, sizeX, sizeY, id);
                    ...
                    int sizeX, int sizeY, const char * title, int id)
                {
                    ...
                    child->Create(WS_CHILD | WS_VISIBLE | CBS_DROPDOWNLIST | WS_TABSTOP, posX, posY, sizeX, sizeY, id);
