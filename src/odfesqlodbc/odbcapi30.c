...
RETCODE SQL_API SQLAllocHandle(SQLSMALLINT HandleType, SQLHANDLE InputHandle,
    ...
    switch (HandleType) {
        ...
        case SQL_HANDLE_DESC:
            ...
            LEAVE_CONN_CS(conn);
            MYLOG(DRV_DEBUG, "OutputHandle=%p\n", *OutputHandle);
            break;
        default:
            ret = SQL_ERROR;
            break;
...
RETCODE SQL_API SQLFetchScroll(HSTMT StatementHandle,
    ...
    MYLOG(DRV_TRACE, "entering %d," FORMAT_LEN "\n", FetchOrientation,
          FetchOffset);
    if (SC_connection_lost_check(stmt, __FUNCTION__))
        return SQL_ERROR;
    ...
    LEAVE_STMT_CS(stmt);
    if (ret != SQL_SUCCESS)
        MYLOG(DRV_TRACE, "leaving return = %d\n", ret);
    return ret;
}
...
RETCODE SQL_API SQLGetDescRec(SQLHDESC DescriptorHandle, SQLSMALLINT RecNumber,
    ...
    MYLOG(DRV_TRACE, "entering\n");
    MYLOG(DRV_DEBUG, "Error not implemented\n");
    return SQL_ERROR;
}
...
RETCODE SQL_API SQLGetDiagField(SQLSMALLINT HandleType, SQLHANDLE Handle,
    ...
    MYLOG(DRV_TRACE, "entering Handle=(%u,%p) Rec=%d Id=%d info=(%p,%d)\n",
...
RETCODE SQL_API SQLGetEnvAttr(HENV EnvironmentHandle, SQLINTEGER Attribute,
    ...
    MYLOG(DRV_TRACE, "entering " FORMAT_INTEGER "\n", Attribute);
    ENTER_ENV_CS(env);
    ret = SQL_SUCCESS;
    switch (Attribute) {
...
RETCODE SQL_API SQLGetConnectAttr(HDBC ConnectionHandle, SQLINTEGER Attribute,
    ...
    MYLOG(DRV_TRACE, "entering " FORMAT_UINTEGER "\n", Attribute);
...
RETCODE SQL_API SQLGetStmtAttr(HSTMT StatementHandle, SQLINTEGER Attribute,
    ...
    MYLOG(DRV_TRACE, "entering Handle=%p " FORMAT_INTEGER "\n", StatementHandle,
          Attribute);
    ENTER_STMT_CS(stmt);
    SC_clear_error(stmt);
...
RETCODE SQL_API SQLSetDescField(SQLHDESC DescriptorHandle,
    ...
    MYLOG(DRV_TRACE, "entering h=%p rec=%d field=%d val=%p\n", DescriptorHandle,
...
RETCODE SQL_API SQLSetEnvAttr(HENV EnvironmentHandle, SQLINTEGER Attribute,
    ...
    MYLOG(DRV_TRACE, "entering att=" FORMAT_INTEGER "," FORMAT_ULEN "\n",
...
RETCODE SQL_API SQLSetStmtAttr(HSTMT StatementHandle, SQLINTEGER Attribute,
    ...
    MYLOG(DRV_TRACE, "entering Handle=%p " FORMAT_INTEGER "," FORMAT_ULEN "\n",
