...
class TestServerSession {
 public:
   ...
   */
  TestServerSession(boost::asio::io_service& service,
 ...
 private:
   ...
   */
  void HandleRequestSizeReceived(const boost::system::error_code& error,
   ...
   * @param bytesTransferred Bytes transferred.
   */
  void HandleRequestReceived(const boost::system::error_code& error,
                             size_t bytesTransferred);
   ...
   * @param bytesTransferred Bytes transferred.
   */
  void HandleResponseSent(const boost::system::error_code& error,
                          size_t bytesTransferred);
...
class TestServer {
 ...
 private:
   ...
   * @param error Error.
   */
  void HandleAccept(boost::shared_ptr< TestServerSession > session,
