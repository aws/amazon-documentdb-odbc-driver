...
namespace ScalarTypeMapper {
    ...
    static const int INTERVAL_DAY_TO_SECOND_HASH =
        HashingUtils::HashString("INTERVAL_DAY_TO_SECOND");
    static const int INTERVAL_YEAR_TO_MONTH_HASH =
        HashingUtils::HashString("INTERVAL_YEAR_TO_MONTH");
    ...
    ScalarType GetScalarTypeForName(const std::string& name) {
        ...
        EnumParseOverflowContainer* overflowContainer =
        ...
        switch (enumValue) {
            ...
            default:
                EnumParseOverflowContainer* overflowContainer =
                    Aws::GetEnumOverflowContainer();
                if (overflowContainer) {
                    return overflowContainer->RetrieveOverflow(
