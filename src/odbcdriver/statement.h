...
struct StatementClass_ {
    ...
    UDWORD iflag;      /* API_AllocStmt parameter */
...
#define SC_get_ARDF(a) (&(SC_get_ARD(a)->fields.ardf))
#define SC_get_APDF(a) (&(SC_get_APD(a)->fields.apdf))
#define SC_get_IRDF(a) (&(SC_get_IRD(a)->fields.irdf))
#define SC_get_IPDF(a) (&(SC_get_IPD(a)->fields.ipdf))
