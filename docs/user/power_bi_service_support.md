#  Connecting Amazon Timestream to Microsoft Power BI Service
...
* Follow [instructions](./power_bi_support.md) to create graph using Amazon Timestream Data connector.
