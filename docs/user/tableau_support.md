# Connecting Amazon Timestream to Tableau Desktop via the Tableau Connector [TBD]

## Overview

Connect an Amazon Timestream data source to Tableau Desktop via the Tableau Connector to create a basic graph.
